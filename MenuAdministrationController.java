...
public class MenuAdministrationController {
    ...
    public ObservableList<FoodItem> addMenuItemsList = FXCollections.observableArrayList();
    DataSourceMenuManager dataSourceMenuManager = new DataSourceMenuManager();

    public void initialize() {
        dataSourceMenuManager.open();
        addMenuItemsList = FXCollections.observableArrayList(dataSourceMenuManager.selectItems());
    ...
    public void addItem (ActionEvent event){
        ...
        try {
            ...
            addMenuItemsList = FXCollections.observableArrayList(dataSourceMenuManager.addFoodItemToMenu(foodName.getText(),Double.parseDouble(rate.getText())));
    ...
    public void removeItem(ActionEvent event){
        ...
        try{
            addMenuItemsList = FXCollections.observableArrayList(dataSourceMenuManager.removeFoodItemFromMenu(foodName.getText()));
